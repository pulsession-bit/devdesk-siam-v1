                          ...
                          <div className="space-y-5">
                              ...
                              <div>
                                  ...
                                  <div className="grid grid-cols-4 gap-2">
                                      <button onClick={() => setContactMethod('whatsapp')} className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all ${contactMethod === 'whatsapp' ? 'border-[#FF9F1C] bg-[#FF9F1C]/10 text-[#051229]' : 'border-slate-100 text-slate-400 hover:bg-slate-50'}`}><MessageCircle size={18} className="mb-1" /><span className="text-[9px] font-bold">WhatsApp</span></button>
                                      <button onClick={() => setContactMethod('phone')} className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all ${contactMethod === 'phone' ? 'border-[#FF9F1C] bg-[#FF9F1C]/10 text-[#051229]' : 'border-slate-100 text-slate-400 hover:bg-slate-50'}`}><Phone size={18} className="mb-1" /><span className="text-[9px] font-bold">Tel</span></button>
                                      <button onClick={() => setContactMethod('email')} className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all ${contactMethod === 'email' ? 'border-[#FF9F1C] bg-[#FF9F1C]/10 text-[#051229]' : 'border-slate-100 text-slate-400 hover:bg-slate-50'}`}><Mail size={18} className="mb-1" /><span className="text-[9px] font-bold">Email</span></button>
                                      <button onClick={() => setContactMethod('zoom')} className={`flex flex-col items-center justify-center p-3 rounded-xl border transition-all ${contactMethod === 'zoom' ? 'border-[#FF9F1C] bg-[#FF9F1C]/10 text-[#051229]' : 'border-slate-100 text-slate-400 hover:bg-slate-50'}`}><Video size={18} className="mb-1" /><span className="text-[9px] font-bold">Zoom</span></button>
                                  </div>
                              </div>
